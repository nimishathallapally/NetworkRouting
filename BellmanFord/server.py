...
class Server:
    def __init__(self, node_id, graph):
        ...
        self.server_socket.bind(("localhost", 8000 + node_id))
        self.server_socket.listen(5)
        self.failed_nodes = set()
        self.routing_table = {}  
        self.is_active = True  
        print(f"Server {node_id} started on port {8000 + node_id}")
    ...
    def recalculate_routing_table(self):
        ...
        self.routing_table, _ = bellman_ford(self.graph, self.node_id)
